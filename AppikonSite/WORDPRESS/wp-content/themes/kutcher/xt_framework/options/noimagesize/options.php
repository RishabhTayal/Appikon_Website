...
function optionsframework_options() {
	...
	************************/
	$options[] = array(
		...
		// Logo Width
		$options[] = array(
		'name' => __('Logo Width', 'options_framework_theme'),
		'desc' => __('Insert logo width, only numbers', 'options_framework_theme'),
		'id' => 'logo_w',
		...
		'desc' => __('Insert logo height, only numbers', 'options_framework_theme'),
		'id' => 'logo_h',
		'std' => '', // use something like #2accee
		'type' => 'text' );
	...
	************************/
	$options[] = array(
		...
		'desc' => __('Edit here the footer text to be displayed', 'options_framework_theme'),
		'id' => 'footer_copyright',
